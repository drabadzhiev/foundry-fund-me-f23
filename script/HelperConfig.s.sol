...
//2 Keep track of cotnract address accross different chains
...
contract HelperConfig is Script {
    ...
    function getMainnetEthConfig() public pure returns (NewtorkConfig memory) {
        // price feed address
        NewtorkConfig memory ethConfig = NewtorkConfig({
            priceFeed: 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419
        });
        return ethConfig;
    }

    function getOrCreateAnvilEthConfig() public returns (NewtorkConfig memory) {
